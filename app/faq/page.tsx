...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer: '계정 삭제를 원하시면 support@connetplt.kr로 이메일을 보내주세요. 계정 삭제 요청 처리 시 모든 개인정보와 조직 정보가 영구적으로 삭제되며, 이는 되돌릴 수 없습니다.',
  },
  {
  ...
  },
  {
    ...
    answer: '매칭 결과에 대한 피드백은 언제든지 환영합니다. support@connetplt.kr로 구체적인 내용을 보내주시면, 알고리즘 개선에 반영하겠습니다. 또한 조직 프로필 정보를 상세하게 업데이트하시면 매칭 정확도가 향상됩니다.',
  },
];
